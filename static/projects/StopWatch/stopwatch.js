//stopwatch.js Algorithm and code
// variables
   //app mide
   //time counter
   //lap counter
   // variable for setInterval, number of laps

//on app load show start and lap button

//on clicking startbutton
  //mode on
  //show stop and lap buttons
  // start counter

//on clicking stopbutton
  //show resume and reset buttons
  //stop counter

//on clicking on resumebutton
  //show stop and lap button
  //start action

//on clicking resetbutton
  //reload the page

// on clicking lapbutton
  //if mode is on
    //stop action
